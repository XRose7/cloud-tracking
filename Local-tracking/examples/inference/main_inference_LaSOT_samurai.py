...
testing_set = "/data/quanjie/LaSOT/testing_set.txt"
...
video_folder= "/data/quanjie/LaSOT"
pred_folder = f"/data/quanjie/LaSOT-results/{exp_name}/{exp_name}_{model_name}"

save_to_video = True
if save_to_video:
    vis_folder = f"/data/quanjie/LaSOT-visualization/{exp_name}/{model_name}"
